...
lineaccesstoken = 'tjKb5+04Ssat+l7hvXDqWk3ZdWlMKrQxyOg28F0AZ2QUU7pxBV++QxtiP0UdCLbUxAOfzVhLFB0cDDRcwHooupphDZqimiXB6TPHrhkRX9ZFHFn9A8jlmWFoDXkTWH6x8PZgJC4AufFf/SWaihQZQAdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี") :
            ...
            replyObj = TextSendMessage(text="บ่")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "ไปเที่ยวไหม") :
            replyObj = TextSendMessage(text="ไปครับ")
            line_bot_api.reply_message(rtoken, replyObj)
        else :
            headers = request.headers
            json_headers = ({k:v for k, v in headers.items()})
            json_headers.update({'Host':'bots.dialogflow.com'})
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/7f674ed4-4b33-4c27-8499-2a5bc1189a6f"
